...
state_join %>%
  ...
  ggplot(aes(x = year, y = mean_revenue_mil, group = state, color = Region)) +
    ...
    labs(title = "Figure 1. Differences in Federal, Local, and State Revenue Over Time by State and Region",
         y = "Revenue * $1,000,000",
         x = "Year") +
...
It appears that coloring by region is pretty useless... so instead, I'd probably try to highlight the top 3 states in each condition (federal, state, local).
...
states_ash %>%
  ...
  ggplot(aes(x = year, y = mean_revenue_mil, color = state)) +
    ...
    labs(title = "Figure 2. Differences in Federal, Local, and State Revenue Over Time by State",
         subtitle = "The three states with the highest total revenue are highlighted: California (light pink), New York (medium/hot pink), and Texas (dark pink/purple)",
         y = "Revenue * $1,000,000",
         x = "Year") +
    scale_x_continuous(breaks = c(1995, 2000, 2005, 2010, 2015),
                       label = c("1995", "2000", "2005", "2010", "2015"),
...
fig1a <- states_ash %>%
  ...
  ggplot(aes(x = year, y = mean_rev_mil, color = state)) +
    ...
    labs(title = "Figure 1. Differences in Federal, Local, and State Revenue Over Time by State",
         subtitle = "Federal",
         y = "Revenue * $1,000,000",
         x = "Year") +
    scale_x_continuous(breaks = c(1995, 2000, 2005, 2010, 2015),
...
Figure1 <- plot_grid(fig1a, fig1b, fig1c, labels = c("", "", ""), align = "h", nrow = 1)
...
#### Help your colleague reproduce the plot to highlight the five highest and lowest revenue states, after accounting for enrollment. Make any other modifications you feel would help aid communication.
